...
<div class="left-sidebar-pro">
  <nav id="sidebar" class="">
    <div class="sidebar-header">
      <a href="<?php echo base_url(); ?>"><img class="main-logo" src="<?php echo base_url('optimum'); ?>/img/logo/logo.png" alt="" /></a>
      <strong><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url('optimum'); ?>/img/logo/logosn.png" alt="" /></a></strong>
    </div>
                  ...
                  <li>
                    ...
                    <ul class="submenu-angle" aria-expanded="false">
                      ...
                      <?php foreach ($topic_article as $key => $topic): ?>
                        <li><a title="<?php echo $topic->article_title ?>" href="<?php echo base_url('app.php?menu=').$value->menu_parent."&topic=".$value->topic_url."&article=". $topic->article_url?>"><span class="educate-icon educate-data-table icon-wrap"></span><span class="mini-sub-pro"><?php echo $topic->article_title ?></span></a></li>
                      <?php endforeach; ?>
                    </ul>
                  </li>
                  <?php else: ?>
                    <li>
                      <a title="Side Menu List" href="<?php echo base_url('app.php?menu=').$value->menu_parent."&topic=".$value->topic_url ?>">
                        <span class="educate-icon educate-course icon-wrap"></span>
