...
<head>
  ...
  <!-- favicon
		============================================ -->
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('optimum'); ?>/img/favicon.ico">
  <!-- Google Fonts
		============================================ -->
 ...
 <link rel="stylesheet" href="<?php echo base_url('optimum'); ?>/css/dropzone/dropzone.css">
  ...
  <!-- Data Table
  ============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('optimum'); ?>/css/datatables.min.css">
  <!-- Swweet Alert
  ============================================ -->
  <link rel="stylesheet" href="<?php echo base_url('optimum'); ?>/lib/sweetalert2/dist/sweetalert2.min.css">
  <!-- style CSS
		============================================ -->
