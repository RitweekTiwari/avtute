...
<!-- Data Table
============================================ -->
<script src="<?php echo base_url('optimum'); ?>/js/datatables.min.js"></script>
<!-- Data Table
============================================ -->
<script src="<?php echo base_url('optimum'); ?>/lib/sweetalert2/dist/sweetalert2.all.min.js"></script>
<!-- dropzone JS
   ============================================ -->
...
<?php if (isset($is_script)){ echo $is_script; } ?>
